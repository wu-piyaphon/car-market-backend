  ...
  describe('create', () => {
    it('should create a car with files', async () => {
      const createDto: CreateCarDto = {
        ...
        mileage: 15000,
        price: 25000,
        previousLicensePlate: 'ABC-123',
        newLicensePlate: 'XYZ-789',
      ...
      const savedEntity: Car = {
        ...
        previousLicensePlate: createDto.previousLicensePlate,
        newLicensePlate: createDto.newLicensePlate,
    ...
    it('should create a car without files', async () => {
      const createDto: CreateCarDto = {
        ...
        mileage: 25000,
        price: 20000,
        previousLicensePlate: 'OLD-123',
        newLicensePlate: 'NEW-456',
